        ...
        for (int ipin = 0; ipin < Dict_Net[NameNet.c_str()].masternet.size(); ++ipin){
            ...
            while(Stop == false){
                ...
                if(Dict_Condition[NameNet.c_str()].minrouting != "NoCstr"){
                    ...
                    // else if(Num_Layer_Select==Dict_Condition["NumLayer"].maxlay){
                    //     Check_minrouting = true;
                    //     X1_row = temrow_select;
                    //     X1_col = temcol_select;
                    //     minlayer = 0;
                    //     Check_downlayer = true;
                    // }
                ...
                if (Check_DentaX_H == true){
                    ...
                    // if(tempdimension_select == Dict_Condition[Layer_consider.c_str()].condicell[0].substr(0,1) & (DentaX_H==0 || DentaX_V==0)){
                    //     tempdimension_select = tempdimension_select;
                    // }
                    // else{
                    //     tempdimension_select = "V";
                    // }
